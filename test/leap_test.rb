# These following lines setup SimpleCov, MiniTest, and loads our lib code
# We can keep these lines here in leap_test.rb...
# OR we can move these lines to a `test_helper` file,
#   and just load THAT test_helper once!
